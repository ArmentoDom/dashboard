  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-16">
      ...
      <div className="container max-w-md mx-auto px-4">
        {/* Header */}
        <header className="py-4 flex items-center justify-between sticky top-0 bg-white/90 backdrop-blur-md z-10 rounded-b-2xl shadow-[0_4px_20px_-5px_rgba(0,0,0,0.1)] border-b border-gray-100">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4">
          <TrackerWidget type="feeding" icon="baby-bottle" color="blue" />
          <TrackerWidget type="sleep" icon="moon" color="purple" />
          <TrackerWidget type="diapers" icon="baby" color="teal" />
        </div>

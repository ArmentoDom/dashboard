...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl bg-white text-card-foreground shadow-[0_8px_30px_rgb(0,0,0,0.12)] relative before:absolute before:inset-0 before:z-0 before:bg-gradient-to-b before:from-white before:to-gray-50 before:rounded-2xl overflow-hidden",
      className,
    )}
    {...props}
  />
